...
@DisplayName("Day 06 - TreeTopView Tests")
class TreeTopViewTest {

    private TreeTopView treetopview;

    @BeforeEach
    void setUp() {
        treetopview = new TreeTopView();
    }
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> treetopview.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> treetopview.solve(null));
        }
    }
}
