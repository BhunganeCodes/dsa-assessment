...
@DisplayName("Day 06 - TreeMirror Tests")
class TreeMirrorTest {

    private TreeMirror treemirror;

    @BeforeEach
    void setUp() {
        treemirror = new TreeMirror();
    }
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> treemirror.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> treemirror.solve(null));
        }
    }
}
