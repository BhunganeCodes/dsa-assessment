...
@DisplayName("Day 08 - FirstUniqueCharacter Tests")
class FirstUniqueCharacterTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> firstuniquecharacter.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> firstuniquecharacter.solve(null));
        }
    }
}
