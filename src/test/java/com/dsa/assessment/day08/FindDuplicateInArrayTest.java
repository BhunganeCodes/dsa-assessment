...
@DisplayName("Day 08 - FindDuplicateInArray Tests")
class FindDuplicateInArrayTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> findduplicateinarray.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> findduplicateinarray.solve(null));
        }
    }
}
