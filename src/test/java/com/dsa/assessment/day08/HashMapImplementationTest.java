...
@DisplayName("Day 08 - HashMapImplementation Tests")
class HashMapImplementationTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> hashmapimplementation.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> hashmapimplementation.solve(null));
        }
    }
}
