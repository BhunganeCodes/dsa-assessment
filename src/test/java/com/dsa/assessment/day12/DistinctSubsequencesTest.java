...
@DisplayName("Day 12 - DistinctSubsequences Tests")
class DistinctSubsequencesTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> distinctsubsequences.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> distinctsubsequences.solve(null));
        }
    }
}
