...
@DisplayName("Day 12 - MaximumProductSubarray Tests")
class MaximumProductSubarrayTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> maximumproductsubarray.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> maximumproductsubarray.solve(null));
        }
    }
}
