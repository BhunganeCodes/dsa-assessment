...
@DisplayName("Day 12 - BurstBalloons Tests")
class BurstBalloonsTest {

    private BurstBalloons burstballoons;
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> burstballoons.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> burstballoons.solve(null));
        }
    }
}
