...
@DisplayName("Day 12 - SplitArrayLargestSum Tests")
class SplitArrayLargestSumTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> splitarraylargestsum.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> splitarraylargestsum.solve(null));
        }
    }
}
