...
@DisplayName("Day 12 - DominoAndTrominoTiling Tests")
class DominoAndTrominoTilingTest {
    ...
    @BeforeEach
    void setUp() {
        dominoandtrominotiling = new DominoAndTrominoTiling();
    }
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> dominoandtrominotiling.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> dominoandtrominotiling.solve(null));
        }
    }
}
