...
@DisplayName("Day 11 - PartitionEqualSubset Tests")
class PartitionEqualSubsetTest {

    private PartitionEqualSubset partitionequalsubset;
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> partitionequalsubset.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> partitionequalsubset.solve(null));
        }
    }
}
