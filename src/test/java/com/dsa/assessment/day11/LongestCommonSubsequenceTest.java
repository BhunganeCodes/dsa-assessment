...
@DisplayName("Day 11 - LongestCommonSubsequence Tests")
class LongestCommonSubsequenceTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> longestcommonsubsequence.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> longestcommonsubsequence.solve(null));
        }
    }
}
