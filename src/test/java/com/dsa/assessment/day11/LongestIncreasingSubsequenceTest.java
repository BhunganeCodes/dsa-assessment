...
@DisplayName("Day 11 - LongestIncreasingSubsequence Tests")
class LongestIncreasingSubsequenceTest {
    ...
    class EdgeCases {
        ...
        void shouldHandleEdgeCase1() {
            ...
            assertDoesNotThrow(() -> longestincreasingsubsequence.solve(null));
        }
    ...
    class NegativeTests {
        ...
        void shouldThrowExceptionForInvalidInput() {
            ...
            assertThrows(Exception.class, () -> longestincreasingsubsequence.solve(null));
        }
    }
}
